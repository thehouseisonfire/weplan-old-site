...
.img-profissionais-especialistas {
  background-image: url('~/assets/images/environments/cozinha-escritorio-nexen.webp');
}
...
.img-adequado-necessidade {
  background-image: url('~/assets/images/environments/estacao-trabalho-nexen.webp');
}

.img-faturamento-direto {
  background-image: url('~/assets/images/environments/refeitorio-nexen.webp');
}

.img-entrega-velocidade {
  background-image: url('~/assets/images/profissional-interiores.webp');
}

.img-solucao-completa {
  background-image: url('~/assets/images/environments/apresentacao.webp');
}
