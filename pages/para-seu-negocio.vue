<template>
  <div>
    ...
    <BContainer fluid class="section-7 section-spacing carousel-container">
      <BRow class="mb-5">
        <BCol cols="12" class="align-self-center text-center">
...
.img-profissionais-especialistas {
  background-image: url('/images/environments/cozinha-escritorio-nexen.webp');
}

.img-orcamento-rapido {
  background-image: url('/images/environments/escritorio.webp');
}

.img-adequado-necessidade {
  background-image: url('/images/environments/estacao-trabalho-nexen.webp');
}

.img-faturamento-direto {
  background-image: url('/images/environments/refeitorio-nexen.webp');
}
...
.img-solucao-completa {
  background-image: url('/images/environments/apresentacao.webp');
}

.img-fornecedores-abnt {
  background-image: url('/images/environments/sala-reuniao-nexen.webp');
}
</style>
