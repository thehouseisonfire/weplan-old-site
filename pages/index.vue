      ...
      <BRow class="background-title">
        <BCol cols="12">
          <BContainer>
            ...
            <p class="mt-4">
              <NuxtLink to="/como-funciona" class="button-link"> Descubra mais </NuxtLink>
            </p>
          </BContainer>
        </BCol>
      </BRow>
      ...
      <BRow>
        <BCol cols="12" md="6" class="align-self-center">
          ...
          <p class="mx-5">
            ...
            recebemos de nossos credenciados e clientes.
          </p>
          <p class="mx-5">
            Para isso,
            <NuxtLink
              ...
              >utilizamos uma das metodologias mais avançadas do mercado: o Net Promoter Score
              (NPS)</NuxtLink
            >.
          </p>
          <p class="mx-5">
