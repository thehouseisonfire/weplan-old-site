  ...
  <div>
    ...
    <b-container id="vantagens-weplan" fluid class="section-4 section-spacing">
      <b-row>
        <b-col cols="12" class="align-self-center text-center">
          ...
          <p class="section-subtitle">
            <span class="highlighted-words-yellow">Entregamos o acesso a móveis</span> planejados com <span class="highlighted-words-yellow">facilidade, respeito e alta qualidade</span>. <span class="highlighted-words-yellow">Conectamos</span> todos os pontos do processo entre <span class="highlighted-words-yellow">indústria, profissional e clientes</span> para desenvolver nosso trabalho de forma rápida e transparente.
          </p>
        </b-col>
      </b-row>
    </b-container>
    <b-container fluid class="section-5 section-background-light-color">
      ...
      <b-row id="vantagem-qualidade">
        <b-col class="img-vantagem-qualidade img-height-600px img-background text-block-with-background-img d-md-none" cols="12" md="6">
          <div>
            <h2>Qualidade</h2>
          </div>
        </b-col>
        <b-col cols="12" md="6" class="align-self-center text-md-right text-block">
          <span class="highlighted-words-yellow">Nossos móveis</span> planejados são reconhecidos pelo <span class="highlighted-words-yellow">nível de qualidade</span> em que são fabricados e isso é ponto primordial para nós e nossos parceiros.
        </b-col>
        <b-col class="img-vantagem-qualidade img-height-600px img-background text-block-with-background-img d-none d-md-block" cols="12" md="6">
          <div>
            <h2>Qualidade</h2>
          </div>
        </b-col>
      </b-row>
      <b-row id="vantagem-facilidade" class="inverted-colors">
        <b-col class="img-vantagem-facilidade img-height-600px img-background text-block-with-background-img" cols="12" md="6">
          <div>
            <h2>Facilidade</h2>
          </div>
        </b-col>
        <b-col cols="12" md="6" class="align-self-center text-block">
          <span class="highlighted-words-yellow">Acabar com a burocracia para projetar e executar móveis planejados</span> é uma dor do mercado, nós acabamos com isso através das conexões entre cliente, profissional e indústria.
        </b-col>
      </b-row>
    </b-container>
